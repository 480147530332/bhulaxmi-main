...
export const CartSheet = () => {
  ...
  return (
    ...
    <SheetContent className="w-full sm:max-w-lg flex flex-col h-[100vh]">
  <SheetHeader>
  ...
  {cart.items.length === 0 ? (
    ...
    <div className="flex-1 flex flex-col">
      ...
      {/* Checkout buttons at bottom */}
      <div className="mt-4 p-4 border-t border-border bg-background flex flex-col gap-3">
